...
export const ENV = {
    BASE_URL: `http://${localhost}:9605/medicine-service`,
    development: {
        BASE_URL: `http://${localhost}:9605/medicine-service`,
        IMAGE_URL: `http://${localhost}:9605/uploads`,
    },
    production: {
        BASE_URL: 'https://dirty-colts-hug.loca.lt/api',
        IMAGE_URL: 'https://cdn.gshop.vn/uploads',
    },
};

// ⚙️ Tự động chọn môi trường dựa vào NODE_ENV
const currentEnv =
